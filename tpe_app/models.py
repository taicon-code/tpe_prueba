...
class SIM(models.Model):
    ...
    TIPO_CHOICES = [
        ...
        ('SOLICITUD DE EXIMIR REQUISITO DE ASCENSO', 'SOLICITUD DE EXIMIR REQUISITO DE ASCENSO'),
    ...
    FASE_CHOICES = [
        ...
        ('EN_AGENDA_EJECUTORIA',      'Agendado para Ejecutoria'),
        ('EN_EJECUTORIA',             'Sesión de Ejecutoria Realizada'),
        ('EJECUTORIA_PARA_NOTIFICAR', 'Auto de Ejecutoria Emitido (Pte. Notificar)'),
    ...
    FASE_A_ESTADO = {
        ...
        'EJECUTORIA_PARA_NOTIFICAR': 'PROCESO_EN_EL_TPE',
    ...
    FASE_TRANSICIONES_VALIDAS = {
        ...
        'EN_ESPERA_RR': ['PARA_AGENDA_RR', 'PENDIENTE_ARCHIVO'],
        ...
        'EN_AGENDA_EJECUTORIA': ['EN_EJECUTORIA'],          # ADMIN1 confirma sesión
        'EN_EJECUTORIA': ['EJECUTORIA_PARA_NOTIFICAR'],    # ABOG2 crea Auto
        'EJECUTORIA_PARA_NOTIFICAR': ['EJECUTORIA_NOTIFICADA'],  # ADMIN3 notifica
...
class Resolucion(models.Model):
    ...
    TIPO_CHOICES = [
        ...
        ('SANCION_LETRA_B',                'SANCIÓN LETRA B'),
        ('PERDIDA_DE_ANTIGUEDAD',          'PÉRDIDA DE ANTIGÜEDAD'),
        ('SANCION_RETIRO_OBLIGATORIO',     'SANCIÓN RETIRO OBLIGATORIO'),
        ...
        ('SOLICITUD_ASCENSO_POSTUMO',      'SOLICITUD DE ASCENSO PÓSTUMO'),
        ('SOLICITUD_DE_EXIMIR_REQUISITO_DE_ASCENSO', 'SOLICITUD DE EXIMIR REQUISITO DE ASCENSO'),
